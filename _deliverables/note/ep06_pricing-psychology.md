...
#マーケティング #マーケティング入門 #価格設定 #行動経済学 #俺のフレンチ

<!-- 見出し画像案: メイン「原価率60%でも儲かる」／サブ「価格設定の心理学」／数字 60%／背景 シリーズ共通色 #0B1220 -->
<!-- 検索KW: 価格設定 心理学（タイトル・リードに配置済み）／アンカリング -->
<!-- タイトル3案: ①原価率60%でも儲かる価格設定の心理学(採用) ②なぜ原価率60%の店は潰れないのか【価格心理学】 ③値下げせずに「安い」と感じさせる3つの設計 -->
