...
ABBR_MAP = {
    ...
    "ChatGPT": "チャットジーピーティー", "GPT": "ジーピーティー", "IC": "アイシー",
    "FAQ": "エフエーキュー",
...
COMPOUND_DICT = {
    ...
    "高田明":              ("タカタアキラ", 4),             # ジャパネットたかた創業者（×タカダ→タカタ。EP10）
    "高田さん":            ("タカタサン", 0),               # 同上の呼称（×タカダサン。EP10）
    "ジャパネットたかた":  ("ジャパネットタカタ", 3),       # 社名を1アクセント句で（×2分割読み。EP10）
    "高岡浩三":            ("タカオカコウゾウ", 5),         # ネスレ日本元社長（浩三を×ヒロミ等の誤読防止。EP18）
    "高岡さん":            ("タカオカサン", 0),             # 同上の呼称（EP18）
    "森岡毅":              ("モリオカツヨシ", 4),           # マーケター（毅を×アツシ→ツヨシ。EP22で確認・EP24でも使用）
    "森岡さん":            ("モリオカサン", 0),             # 同上の呼称（EP24）
    "西口一希":            ("ニシグチカズキ", 5),           # マーケター（VOICEVOX既定読みで正しいが1語化のため登録。EP24）
    "西口さん":            ("ニシグチサン", 0),             # 同上の呼称（EP24）
}
