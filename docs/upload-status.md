...
> 自動生成：2026-08-03 00:52 UTC ／ ソース＝各話 publish_manifest.json の videoId を YouTube videos.list で実照会
...
| EP19 | `ep19_marketing-org` | `G3muSAmlt24` | private | `EmClF8jY5VQ` `YygfOVwGTQU` `6WS45RYYqQ8` | private |
| EP20 | `ep20_growth-hack` | `O3ANMg1Fdb8` | private | `vDsbd_XZWik` `2Wpkmd5MEx8` `fay9Jyghva4` | private |
| EP21 | `ep21_hit-products` | — | 未UP | — | — |
| EP22 | `ep22_v-shaped-recovery` | — | 未UP | — | — |
| EP23 | `ep23_failure-cases` | — | 未UP | — | — |
| EP24 | `ep24_future-marketer` | — | 未UP | — | — |

**集計**：manifest記録 77本中 public=32 / private=45 / 削除=0

## 残作業
- private の回：Studioで公開（or 公開予約）
- 各Short：Studioで「関連動画」に本編を設定（API不可）
- 未UP：EP21／EP22／EP23／EP24
